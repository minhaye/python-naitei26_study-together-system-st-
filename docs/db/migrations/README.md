...
| 020 | `020_create_tasks.sql` | ⏳ Pending | Creates personal `tasks` with owner-scoped RLS policies and least-privilege authenticated grants. Run `020_preflight.sql`, then this migration, then `020_verify.sql`. |
