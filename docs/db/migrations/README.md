...
2026-08-19 (014, 015) — update this table whenever a migration is actually run live.
...
Full design/rationale for 004-006: `docs/db/STUDY_PLATFORM_DATABASE_SPEC.md` § 12–15. For 007: § 37. For 008: § 8, § 34. For 009: § 9. For 010/011: § 16, § 22. For 012: § 14. For 013: `docs/invitations.md`. For 014/015: § 24.
