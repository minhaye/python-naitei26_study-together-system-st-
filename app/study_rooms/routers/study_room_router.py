...
from app.core.permissions import can_access_room, can_join_room, can_join_room_meeting, can_manage_room, is_room_host
...
async def create_room(
    ...
    try:
        # data.host_id is client-supplied and never trusted as identity; the
        # authenticated caller always becomes the host.
