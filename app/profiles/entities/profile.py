...
if TYPE_CHECKING:
    ...
    from app.forum.entities.forum import Comment, CommentLike, ForumPost, PostLike
    ...
    from app.study_rooms.entities.study_room import RoomModerationAction, StudyRoom, StudyRoomMember
