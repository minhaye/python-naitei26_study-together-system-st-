...
from app.models.enums import ModerationAction, StudyRoomMemberRole, StudyRoomStatus
...
class StudyRoomCreate(BaseModel):
    ...
    # status/started_at/ended_at are lifecycle-managed (see crud.study_room.start_room/end_room), not set on create.
...
class StudyRoomUpdate(BaseModel):
    ...
    # status/started_at/ended_at intentionally excluded: use start_room/end_room to keep them consistent.
